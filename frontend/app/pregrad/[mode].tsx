...
const FORMAL_SECTIONS: PregradSection[] = [
  { id: "s-education", title: "Education", entries: [] },
  { id: "s-experience", title: "Experience", entries: [] },
  { id: "s-projects", title: "Projects", entries: [] },
  { id: "s-awards", title: "Awards & Recognition", entries: [] },
  { id: "s-skills", title: "Skills", entries: [] },
  { id: "s-extra", title: "Extracurriculars", entries: [] },
];
        ...
        <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: 40 + insets.bottom, gap: spacing.lg }} keyboardShouldPersistTaps="handled">
          ...
          {isFormal && (
            <View style={styles.exportNote}>
              ...
              <Text style={styles.exportText}>Save then print/export as PDF from your browser preview (Publish app → open in browser → File → Print → Save as PDF).</Text>
            </View>
          )}
        </ScrollView>
